...
vector <pair<pair<pair<string, string>, set<int>>, int>> leftHand = {
    ...
    {{{"Left hand", "Diamond Watermelon"}, {1, 2, 3, 4}}, 8},
};
...
vector <pair<pair<pair<string, string>, set<int>>, int>> decoration = {
    ...
    {{{"Decoration", "Labor and valor medal"}, {1, 2, 3, 4}}, 5},
